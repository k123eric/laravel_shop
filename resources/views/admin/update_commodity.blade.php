...
@section('content')
                ...
                <form method="POST" action="{{ route('admin.update') }}" class="form-horizontal" enctype="multipart/form-data" role="form">
                    ...
                    <fieldset>
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="id">商品編號</label>
                            <div class="col-md-9">
                                <input id="id" name="id" type="text" readonly="readonly" placeholder="商品編號" class="form-control input-md" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div>
                            ...
                            <div class="col-md-9">
                                <div class="card" style="width: 17rem;">
                                    <img src="{{$commodity->image_url}}" class="card-img-top" alt="無法顯示圖片" id="image_preview" style="height:16rem">
                                    <div class="card-body">
                                        <h5 class="card-title" id="name_preview">{{$commodity->name}}</h5>
                                        價格:<p class="card-text" id="price_preview">{{$commodity->price}}</p>
    ...
    <script>
        ...
        function set_value(){
            ...
            $('#image_url').val('{{$commodity->image_url}}');
            $('#introduction').val('{{$commodity->introduction}}');
        }
    </script>
@endsection
